...
import { getAdminTnfo } from "~/services/db/admins.server";
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const [admin, cities] = await Promise.all([getAdminTnfo(user.id), getCities()])
...
export default function Layout() {
  ...
  return <>
    <Header breadcrumbs={breadcrumbs} user={user} cities={cities} admin={admin} />
    <Outlet />
  </>
}
