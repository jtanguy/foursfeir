...
export interface BookingService {
  ...
  deleteBooking(
    booking: Pick<Booking, "city" | "user_id" | "date">,
  ): Promise<void>;
...
export function groupBookings<B extends Booking>(
  input: B[],
): Record<Period, B[]> {
...
export function isOverflowBooking(
  booking: IndexedBooking,
  capacity: number,
): boolean {
...
export function getRequestPeriod(
...
export function getAllDatesFromPeriod([start, end]: [
  Temporal.PlainDate,
  Temporal.PlainDate,
]): string[] {
